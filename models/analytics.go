...
type DailySales struct {
	...
	// Revenue es el BRUTO: lo que se cobró a la tarjeta, con la comisión de
	// Pull dentro. RevenueNet es lo que se lleva el local — la que hay que
	// pintarle a la dueña. Ver event_stats_controller.go.
	Revenue    float64 `json:"revenue"`
